//
//  JQAlertPresentationController.swift
//  AlertTest
//
...
class JQAlertPresentationController: UIPresentationController {

    var animation: JQBaseAnimation?
...
extension JQAlertPresentationController: UIViewControllerTransitioningDelegate {
