...
class JQBottomAnimation: JQBaseAnimation {
    ...
    override func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if isPresenting {
            ...
            let toVC = transitionContext.viewController(forKey: .to) as! JQBaseAlertViewController
            ...
            let tempFromVC = fromVC as! JQBaseAlertViewController
